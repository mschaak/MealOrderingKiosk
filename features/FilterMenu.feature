Feature: Allow students to filter the menu by dietary restrictions
  ...
  Scenario: Student wants to see vegan meals
    When I am on the daily menu page
    And I check the "vegan" checkbox
    Then I should see "vegan" meals
